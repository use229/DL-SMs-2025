...
def training_model(dataset_path,latent_vectors_name,savemodel_name):
    ...
    #..\\dataset\\dataset1.xlsx         Integration of bandgap data for models with ground-based components
    #..\\dataset\\无地上禁带数据整合1.xlsx  Integration of bandgap data for models without ground-based components
